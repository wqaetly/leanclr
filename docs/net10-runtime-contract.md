...
- `powershell -ExecutionPolicy Bypass -File scripts\dotnet10\legacy-managed-audit.ps1`：366 个旧 managed 文件已链接，9 个未链接 active-ish 文件全部已分类。
